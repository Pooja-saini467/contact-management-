...
const ContactItem = ({ contact }) => {
  ...
  const { id, name, email, phone,country,state,address, type } = contact
    ...
    <>
      <div className="flex items-center justify-center w-full mx-auto mt-2 mb-2 ">
        <ul className="w-4/5 mx-auto transition duration-500 ease-in-out transform hover:-translate-x-1 hover:scale-105">
          <li className="col-span-1 transition duration-200 divide-y divide-gray-100 rounded-lg shadow-2xl bg-black">
            <div className="flex items-center justify-between w-full p-6 space-x-6">
              <div className="flex-1 truncate">
                <div className="flex items-center space-x-3">
                  ...
                  <span
                    className={
                      'flex-shrink-0 inline-block px-2 py-0.5 text-green-800 text-xs font-medium bg-blue-100 rounded-full'
                    }
                  >
